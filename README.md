...
- **SNAP (Sentinel Application Platform) Toolbox**: You need to have SNAP installed for running DSM processing. Download it from [SNAP](https://step.esa.int/main/download/snap-download/). And Attribute **Snappy** to the Python in your environment.
